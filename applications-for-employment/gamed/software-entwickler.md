...
|Fähigkeit sich schnell in komplexe Systeme einzuarbeiten|✔️|Man kann sich, meiner Meinung nach, kaum *schnell* in **komplexe** Systeme einarbeiten. Die Hauptaufgabe und die größte Herausforderung der Software-Entwicklung (jenseits der Hello-World-Lösungen) sollte meines Wissens die Behandlung (Reduktion soweit möglich) der Komplexität sein.|
...
Hiermit könnte man meinen, dass die zuletzt genannten Benefits zwar quantifizierbar aber kaum relevant sind. Im Vergleich zu einem richtig gut eingerichteten Arbeitsplatz (Räumlichkeiten und Ausstattung samt Software und Services), welcher auch am Grazer Stadtrand `€ 1.000` pro EntwicklerIn und Monat (und `1/3` des gelisteten Grundgehaltes zusätzlich) wert sein könnte. Was wiederum ohne tolle / motivierte / engagierte Kollegen wenig wert wäre.
